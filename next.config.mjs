        ...
        headers: [
          {
            ...
            value: [
              ...
              "connect-src 'self' blob: https://api.pinata.cloud https://gateway.pinata.cloud https://gateway.lighthouse.storage https://*.lighthouse.storage https://ipfs.io https://dweb.link https://sepolia.base.org",
